...
export interface KnownTargetsDataQuality {
  ...
  /** Lager 1.13 — suppliers med koordinater men utan radius. */
  suppliersMissingRadius: Array<{ targetId: string; label: string; address: string | null }>;
}
...
export async function buildKnownTargetsEvidence(
  ...
  const diag: KnownTargetsDiagnostics = {
    ...
    supplierTablesUsed: [],
    supplierTablesSkippedMissingOrgScope: [],
    supplierRowsSkippedMissingOrgScope: 0,
    supplierExamples: [],
