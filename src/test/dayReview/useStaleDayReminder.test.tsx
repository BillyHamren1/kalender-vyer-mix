 ...
 *   • visar INTE toast när allt är ready
 *   • throttlas via localStorage (cooldown)
 *   • re-checkar på 'workday-ended' (dag-avslut)
 *   • inaktiv när enabled=false
 */
...
describe('useStaleDayReminder', () => {
  ...
  it('throttlas (cooldown): ingen ny toast om samma dag redan visats nyss', async () => {
    listWorkdaysReview.mockResolvedValue({
      workdays: [
        { id: 'wd-y', day_key: yesterdayKey(), review_status: 'needs_review' },
      ],
