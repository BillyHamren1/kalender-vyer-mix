...
const translations = {
  ...
  'overview.empty.anomalies': { sv: 'Inga avvikelser', en: 'No anomalies' },
  'overview.state.loading': { sv: 'Laddar översikt…', en: 'Loading overview…' },
  'overview.state.forbidden': { sv: 'Du saknar behörighet till översikt', en: 'You lack permission to view the overview' },
  'overview.state.forbiddenDesc': { sv: 'Endast planerare och administratörer kan se denna vy.', en: 'Only planners and admins can access this view.' },
  'overview.state.error': { sv: 'Kunde inte ladda översikt', en: 'Failed to load overview' },
  'overview.state.errorDesc': { sv: 'Försök igen om en stund eller kontakta support om felet kvarstår.', en: 'Please try again shortly or contact support if the issue persists.' },
  'overview.state.empty': { sv: 'Ingen planering i valt intervall', en: 'No planning in the selected range' },
  'overview.range.week': { sv: 'Vecka', en: 'Week' },
  'overview.filter.all': { sv: 'Alla', en: 'All' },
  'overview.filter.anomalies': { sv: 'Avvikelser', en: 'Anomalies' },
  'overview.kpi.jobs': { sv: 'Jobb', en: 'Jobs' },
  'overview.kpi.staff': { sv: 'Personer planerade', en: 'Staff planned' },
  'overview.kpi.unstaffed': { sv: 'Ej bemannade', en: 'Unstaffed' },
  'overview.kpi.anomalies': { sv: 'Avvikelser', en: 'Anomalies' },
  'overview.section.jobs': { sv: 'Dagens jobb', en: "Today's jobs" },
  'overview.section.staff': { sv: 'Personalöversikt', en: 'Staff overview' },
  'overview.section.anomalies': { sv: 'Avvikelser', en: 'Anomalies' },
  'overview.section.messages': { sv: 'Meddelanden', en: 'Messages' },
  'overview.staffStatus.unstaffed': { sv: 'Saknar bemanning', en: 'Unstaffed' },
  'overview.staffStatus.planned': { sv: 'planerade', en: 'planned' },
  'overview.anomaly.unstaffed': { sv: 'Jobb utan bemanning', en: 'Job without staffing' },
  'overview.anomaly.orphanAssignment': { sv: 'Bemanning utan kalenderpost', en: 'Assignment without calendar' },
  ...
  // Timer
  'timer.started': { sv: 'Tid registreras här', en: 'Time is being registered here' },
  'timer.stopped': { sv: 'Slutade registrera tid här', en: 'Stopped registering time here' },
  'timer.stoppedCreateReport': { sv: 'Slutade registrera här – skapa tidrapport', en: 'Stopped registering here – create time report' },
  'timer.alreadyActive': { sv: 'Tiden registreras redan på en annan plats. Sluta där först.', en: 'Time is already being registered elsewhere. Stop there first.' },
  'timer.active': { sv: 'Registreras här', en: 'Registering here' },
  'timer.activeTimers': { sv: 'Aktiv registrering', en: 'Active registration' },
  'timer.stop': { sv: 'Sluta här', en: 'Stop here' },
  'timer.startedAt': { sv: 'Sedan', en: 'Since' },
  ...
  'lager.startTimer': { sv: 'Registrera tid här', en: 'Register time here' },
  'lager.stopTimer': { sv: 'Sluta registrera här', en: 'Stop registering here' },
  ...
  'locDetail.startTimer': { sv: 'Registrera tid här', en: 'Register time here' },
  'locDetail.stopTimer': { sv: 'Sluta registrera här', en: 'Stop registering here' },
