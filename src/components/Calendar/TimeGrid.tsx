...
const TimeGrid: React.FC<TimeGridProps> = ({
  ...
  dayWidth = 900 // Increased default width
}) => {
  ...
  // Calculate responsive column widths with much better space allocation
  const timeColumnWidth = 80; // Fixed width for time column
  const availableWidth = dayWidth - timeColumnWidth - 20; // Subtract padding
  const teamColumnWidth = Math.max(130, Math.floor(availableWidth / resources.length)); // Minimum 130px per team, much more generous
