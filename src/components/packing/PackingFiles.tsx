...
import { PackingFile } from "@/types/packing";
import { format } from "date-fns";
import { sv } from "date-fns/locale";

interface PackingFilesProps {
  files: PackingFile[];
...
const PackingFiles = ({ files, onUpload, onDelete, isUploading }: PackingFilesProps) => {
