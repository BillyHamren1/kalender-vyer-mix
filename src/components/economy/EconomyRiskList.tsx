      ...
      <Card className="border-border/40">
        <CardContent className="p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-base font-semibold">Risk & kontrollista</h2>
          </div>
          <p className="text-sm text-muted-foreground text-center py-6">Inga projekt kräver uppmärksamhet just nu</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <Card className="border-border/40 border-destructive/20">
      <CardContent className="p-5">
        ...
        <div className="space-y-1">
          {risks.slice(0, 10).map(({ project: p, reasons }) => {
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-1">
                    {reasons.map((r, i) => (
                      <span key={i} className="text-[10px] text-destructive/80 bg-destructive/5 px-1.5 py-0.5 rounded">
                        {r}
                      </span>
                    ))}
                  </div>
