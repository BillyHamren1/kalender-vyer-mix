...
const WarehouseServicePlaceholder = () => {
  return (
      ...
      <div className="relative">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-[1600px]">
          <div className="max-w-lg mx-auto text-center rounded-2xl border border-border/40 shadow-2xl bg-card p-12">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-[hsl(var(--heading))] mb-2">Service</h2>
            <p className="text-muted-foreground text-[0.925rem] leading-relaxed mb-4">
              Denna sektion är under utveckling. Här kommer du kunna hantera service och underhåll av utrustning.
            </p>
...
export default WarehouseServicePlaceholder;
