    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-warehouse/10 rounded-lg">
            <Package className="h-6 w-6 text-warehouse" />
          </div>
          <div>
        ...
        <Button className="bg-warehouse hover:bg-warehouse-hover text-white" onClick={() => setIsCreateOpen(true)}>
