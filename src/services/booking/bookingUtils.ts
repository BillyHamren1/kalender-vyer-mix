...
export const transformBookingData = (dbBooking: any): Booking => {
  return {
    ...
    rigStartTime: dbBooking.rig_start_time,
    rigEndTime: dbBooking.rig_end_time,
    eventStartTime: dbBooking.event_start_time,
    eventEndTime: dbBooking.event_end_time,
    rigDownStartTime: dbBooking.rigdown_start_time,
    rigDownEndTime: dbBooking.rigdown_end_time,
