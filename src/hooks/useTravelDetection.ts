...
// (haversineDistance removed — no longer used after speed-based auto-start
// was retired. Distance/gap-rimlighet beräknas server-side i
// `create_travel_from_gap` baserat på timing, inte GPS-fart.)
